...
int main (int argc, char *argv[])
{
	...
	trisD = (long)0x0000;  //Setting D0-7 to outputs, D8-15 to inputs (b0000000011111111)
	trisIO = (long)0xF;  //Setting IO0-1 to outputs, IO2-3 to inputs (b0011)
	stateD = (long)0x0000;  //Setting D0-3 to low. D4-7 to high (b0000000011110000)
	stateIO = (long)0xF;  //Setting IO0 to low. IO1 to high (b0010)
